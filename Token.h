...
enum TOK_TYPE{TOK_TYPE_DECL, TOK_BOOL_LIT, TOK_INT_LIT, TOK_FLOAT_LIT, TOK_IDENTIFIER, TOK_MULT_OP, TOK_DIV_OP, TOK_ADD_OP, TOK_REL_OP,
                        ...
                        TOK_COMMA, TOK_EOF, TOK_LINE_COMMENT, TOK_BLOCK_COMMENT, TOK_SYNTAX_ERR, TOK_ELSE}; //defining possible token type states
